...
Transcripts live under your runtime's transcript directory; the system prompt names the active workspace's `agent-transcripts/` path. Every line is one chat message.
