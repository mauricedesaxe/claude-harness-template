...
| **`/matt-handoff`** | Write a portable markdown file and seed a session anywhere with it. |
...
**3. Do you need to hand off?** `/matt-handoff` is narrow. You need it only when you are:
...
That list is the whole clause. What `/matt-handoff` buys is **portability** — a file that travels. If nothing is travelling, you don't need it.
...
| Secondary (`/compact`, `/matt-handoff`) | Lossy       | Less  | Lots         |
